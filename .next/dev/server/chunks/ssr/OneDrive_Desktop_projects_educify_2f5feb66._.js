...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$projects$2f$educify$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchDashboardData = async ()=>{
            ...
            try {
                // Listen for enrollment created events so dashboard updates in real-time
                function onEnrollmentCreated(e) {
                    try {
                        const payload = e?.detail;
                        if (!payload) return;
                        // If we already have dashboard data, push new enrollment
                        setDashboardData((prev)=>{
                            if (!prev) return prev;
                            // If enrollment already exists, ignore
...
//# sourceMappingURL=OneDrive_Desktop_projects_educify_2f5feb66._.js.map